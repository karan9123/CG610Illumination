...
function bindVAO (shape, program) {
    ...
    gl.bindBuffer(gl.NORMAL_ARRAY_BUFFER, null, null);
    // return the VAO
...
function setUpPhong(program) {
  ...
  let aLight = glMatrix.vec3.fromValues(0.2, 0.2, 0.2)
  gl.uniform3fv(program.ambientLight, aLight)
...
function setUpCamera(program) {
    ...
    //  glMatrix.mat4.lookAt(viewMatrix, [0, 0, 13], [0, 0, 0], [0, 1, 0]);
